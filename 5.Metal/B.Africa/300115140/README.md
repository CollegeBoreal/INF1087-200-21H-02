...
Avant tout, je vérifie si Kubernetes est actif et en mode "Running". L'applicaion ne pourra pas se déployer sans le Kubernetes.
<img src="https://github.com/CollegeBoreal/INF1087-200-21H-02/blob/main/5.Metal/B.Africa/300115140/IMAGES/runn.PNG" width="850">


Ensuite, il est nécessaire de vérifier si les nodes de la grappe Africa marche et sont en bon état.


<img src="https://github.com/CollegeBoreal/INF1087-200-21H-02/blob/main/5.Metal/B.Africa/300115140/IMAGES/nodes.PNG" width="850">

Pour permettre une optimisation du déployement, je vérifie si les nodes d ela grappes sont prêts (mode Ready):
