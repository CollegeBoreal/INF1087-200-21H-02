...
- [ ] Pour utiliser [cStor](https://docs.openebs.io/docs/next/cstor.html) comme `Moteur de Stockage` en concordance avec le `CSI` , fournir quelques [operations](adminop.md):pinching_hand: d'administration.
