...
- [ ] Installer le [CRI](https://kubernetes.io/docs/setup/production-environment/container-runtimes/) correspondant au Service [:whale: Docker](.doc/docker.md)  ( :bulb: __À installer uniquement si Docker n'est pas sur le serveur__ )
